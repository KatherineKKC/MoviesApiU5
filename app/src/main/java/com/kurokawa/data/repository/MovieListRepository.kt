...
class MovieListRepository(
    ...
    private val applicacion: MyApplication
) {
    ...
    suspend fun getByCategory(category: String) =
        applicacion.myDataBase.movieDao().getMoviesByCategory(category)
    ...
    fun showMessageSuccessfulConsole(listIntoRoom: List<MovieEntity>) {
        Log.e(
            ...
            "se guardaron todas las peliculas en ROOM  ${listIntoRoom.size}"
        )
    }
